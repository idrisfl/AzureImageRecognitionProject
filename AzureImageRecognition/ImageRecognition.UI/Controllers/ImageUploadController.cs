...
public class ImageUploadController : Controller
{
    ...
    {
        var _imageRecognitionApiBaseUrl = config.GetValue<string>("ImageRecognitionAPIBaseUrl");
    ...
    {
        List<string> resultOriginal = new();
        List<string> translatedResult = new();

        try
        {
            List<ImageResult> imageResult = new();
